...
public class RedTwelveArtifactFromObelisk extends SequentialCommandGroup {
  private final Follower follower;
  private final Intake intakeWheel;

  // Poses
  private final Pose startPose = newPose(118, 130, 218);
  ...
  public RedTwelveArtifactFromObelisk(final Drivetrain drive, final Intake intake) {
